---
name: Figma file references
description: Links to the working Figma file and the reference portfolio Figma for component building patterns
type: reference
...
- **Design system book chapters (local):**
  ...
  - Ch 6 Component Anatomy: `...Chapter_06_Component_Anatomy_v3-2.md`
  - Ch 7 Design Tokens: `...Chapter_07_Design_Tokens_v3-2.md`
  - Ch 10 Typography: `...Chapter_10_Typography_v3-3.md`
